...
copy ..\..\NugetUtilities.Shared\bin\Debug\NugetUtilities.Shared.* .
copy ..\..\NugetUtilities.UpdateVersion\bin\Debug\UpdateVersion.* .
copy ..\..\NugetUtilities.UpdateReleaseNotes\bin\Debug\UpdateReleaseNotes.* .
...
..\nuget pack NugetUtilities.nuspec
